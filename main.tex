...
def incmatrix(genl1,genl2):
    ...
    return M
    \end{minted}
    \Description[Sample Python code]{Sample Python code with a function.}
    \caption{Python code}
    \label{fig:python}
\end{figure}

\paragraph{Cleveref} Essential for cross-referencing. \Cref{sec:intro} is an introduction. \Cref{fig:python} is a Python code.

\paragraph{SVG} SVG should work. See \cref{fig:svg-sample}.

\begin{figure}
    \centering
    \includesvg{figures/couch.svg}
    \caption{Sample SVG image}
    \Description[Sample SVG image]{Sample SVG image with a green couch.}
    \label{fig:svg-sample}
\end{figure}

\paragraph{TODO} Use \mintinline{latex}{\todo{}} to mark todos. \todo{This is a todo.}
